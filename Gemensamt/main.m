...
anchor = 22; % Anchor, freezing point
...
toc
% tic
% [U,u, X] = Holger2DEuCallTransform(X_eval,smax, K, T, r, sig1,sig2, rho, anchor, n, M, ep); %our
% toc
...
figure
plot3(X(:,1), X(:,2), u, "ro")
title("Solution at 'Center' Points")
