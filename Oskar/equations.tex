...
\centering
    ...
    table [x index = 0,y index= 1] {time.txt}
    ;
     \addplot[
     color=black,
     mark=diamond*,
     ]
     table [x index= 4,y index= 5]{time.txt}
     ;
     \addplot[
     color=blue,
     mark=*,
     ] 
    table [x index= 6 ,y index= 7] {time.txt}
    ;
    \addplot[
    color = red,
    domain = 2:30,]
...
color = red,
only marks,]
table [x index=0,y index=1,]{XCentD2M1.txt};
\end{axis}
\end{tikzpicture}
\caption{Dim2 max1}
\end{figure}
...
color = red,
only marks,]
table [x index=0,y index=1,]{XCentD2M2.txt};
\end{axis}
\end{tikzpicture}
\caption{Dim2 max1}
\end{figure}
...
color = red,
only marks,]
table [x index=0,y index=1,z index = 2]{XCentD3M1.txt};
\end{axis}
\end{tikzpicture}
\caption{Dim2 max1}
\end{figure}
...
color = red,
only marks,]
table [x index=0,y index=1,z index = 2]{XCentD3M2.txt};
\end{axis}
\end{tikzpicture}
\caption{Dim3 max2}
\end{figure}
...
color = red,
only marks,]
table [x index=0,y index=1,z index = 2]{XCentD3M3.txt};
\end{axis}
\end{tikzpicture}
\caption{Dim3 max3}
\end{figure}
...
\centering
    ...
    table [x index = 0,y index= 1] {NIncrese.txt}
    ;
     \addplot[
     color=black,
     mark=diamond*,
     ]
     table [x index= 0,y index= 2]{NIncrese.txt}
     ;
     \addplot[
     color=blue,
     mark=*,
     ] 
    table [x index= 3 ,y index= 4] {NIncrese.txt}
    ;
    \addplot[
    color = black,
    domain = 1:35,]
...
\addplot3
[surf,shader=faceted]
table [x index = 0, y index = 1, z index = 2]{SolutionD2M2.txt};
\end{axis}
\end{tikzpicture}
...
\addplot3
[surf,shader=faceted]
table [x index = 0, y index = 1, z index = 2]{ErrorD2M2.txt};
\end{axis}
\end{tikzpicture}
